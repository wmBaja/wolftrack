...
MOCKED_FUEL_DATA_FILE_NAME = './hardware/mock_voltages.txt'
...
class FuelPoller(SensorPoller):
  ...
  def poll(self):
    ...
    return {
      'remainingPercentage': self.remainingPerc,
      'remainingLiters': self.remainingLiters,
      'remainingLitersEMA': self.emaLiters
    }
